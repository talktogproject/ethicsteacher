...
- Make sure that your electronic devices and online accounts are secure by installing the latest security updates, [using strong passwords (including the use two-factor authentication where possible), and being alert to hacking and phishing scams](https://www.infosec.ox.ac.uk/make-my-online-accounts-secure#tab-444596). Do your best to avoid physically misplacing or losing the device(s) that you use for research. 
