...
- Make sure that your electronic devices and onlines accounts are secure by installing the latest security updates, [using strong passwords (and use two-factor authentication where possible), and being alert to hacking and phishing scams](https://www.infosec.ox.ac.uk/make-my-online-accounts-secure#tab-444596). 
