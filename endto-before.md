...
Although many research committees consider parental or caregiver consent to be enough for child participants, it is also ideal to gain assent from the children participating in the study. Assent from a child is an active agreement to participate in the research study. Ways of gaining assent will differ depending on the age of the child. For example, a teenager may be able to read and sign an assent form, but for a younger child, the researcher might need to explain what is happening orally and/or with the aid of pictures.
